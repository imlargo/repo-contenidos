...
export const load = (async () => {
	const asignatura: Asignatura = {
		...
		planes_relacionados: [
			{ codigo: '3535', nombre: 'INGENIERÍA ELÉCTRICA' },
			{ codigo: '3531', nombre: 'INGENIERÍA DE CONTROL' },
			{ codigo: '3520', nombre: 'INGENIERÍA DE SISTEMAS E INFORMÁTICA' },
			{ codigo: '3534', nombre: 'INGENIERÍA DE SISTEMAS E INFORMÁTICA' },
			{ codigo: '3647', nombre: 'CIENCIAS DE LA COMPUTACIÓN' }
		]
	};
